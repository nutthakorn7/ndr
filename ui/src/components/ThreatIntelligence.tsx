...
import { 
  ...
  RefreshCw, CheckCircle, XCircle, Target, Zap, Activity
} from 'lucide-react';
  ...
  useEffect(() => {
    ...
    const loadThreatData = async () => {
      ...
      try {
        ...
        // Mock Data Fallback
        setFeeds(mockThreatFeeds as Feed[]);
        setMatches(mockThreatMatches as Match[]);
        setStats(mockThreatStats as ThreatStats);
      } finally {
        setLoading(false);
      }
    };
      ...
      <div className="intel-stats-row">
        <div className="intel-stat-card">
          ...
          <div className="stat-info">
            <div className="stat-value">{stats?.totalIocs ? (stats.totalIocs / 1000000).toFixed(1) : 0}M</div>
